function cqtKernel = oGenCQTkernel(fmax, bins, fs, varargin)
%% this code is based on CQT toolbox for matlab from Christian Sch�rkhuber, Anssi Klapuri 2010-06
%
...
winFct = sqrt(oBlackmanharris(Nk));
